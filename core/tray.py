...
class LuminaTray:
    ...
    def _get_text(self, key):
        ...
        texts = {
            "en": {"open_web_ui": "Open Web UI", "open_github": "Open GitHub", "exit": "Exit"},
            "zh": {"open_web_ui": "打开WebUI", "open_github": "打开GitHub", "exit": "退出"},
        }
    ...
    def setup_tray(self):
        ...
        self.icon = pystray.Icon("LuminaStudio", image, "Lumina Studio v1.6.3", menu)
